...
\usepackage[title={Formal Languages and Compilers}, date={2022/2023}]{notestemplate}
\usepackage{flc}
...
\begin{itemize}
  ...
  \item type specification for }non-terminals is done in the special \textbf{\texttt{\%type} instruction}
\end{itemize}
