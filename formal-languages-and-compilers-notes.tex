...
% slide 12, page 39
\begin{enumerate}[label=step \arabic*., ref=(step \arabic*), leftmargin=*]
...
A formal definition of this concept is shown in \ref{def:language-infinity}.
...
\begin{enumerate}[label=row \arabic*.]
...
\subsection{Purely Syntactic Translation}
...
\subsection{Two Input automaton}
